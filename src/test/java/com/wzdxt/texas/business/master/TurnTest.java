...
public class TurnTest extends TexasMasterTestBase {
    ...
    public void suggestAA() throws Exception {
        ...
        test("♠A♥A", "♣4♦2♦3♥6", MasterDecision.CALL_2);
        test("♠A♥A", "♣7♦9♦8♥6", MasterDecision.CHECK_OR_FOLD);
        test("♠A♥A", "♣3♦8♦J♥9", MasterDecision.BET_2_10);
    }

    @Test
    public void suggest44() throws Exception {
        test("♠4♥4", "♣4♦K♦3♥A", MasterDecision.BET_25_50);
        test("♠4♥4", "♣3♦K♦3♥A", MasterDecision.CHECK_OR_FOLD);
        test("♠4♥4", "♣K♦K♦3♥K", MasterDecision.BET_2_10);
        test("♠4♥4", "♣4♦K♦10♥K", MasterDecision.ALL_IN);
        test("♠4♥4", "♣K♦A♦3♥Q", MasterDecision.CHECK_OR_FOLD);
    }

    @Test
    public void suggest1010() throws Exception {
        test("♠10♥10", "♣A♦K♦3♣J", MasterDecision.CHECK_OR_FOLD);
        test("♠10♥10", "♣A♦K♦Q♣J", MasterDecision.ALL_IN);
        test("♠10♥10", "♣3♦K♦3♣J", MasterDecision.CHECK_OR_FOLD);
        test("♠10♥10", "♣K♦K♦3♣J", MasterDecision.CALL_2);
        test("♠10♥10", "♣K♦K♦10♣9", MasterDecision.ALL_IN);
        test("♠10♥10", "♣5♦4♦J♣8", MasterDecision.CALL_2);
    }
    ...
    public void suggestQA() throws Exception {
        ...
        test("♠Q♥A", "♣A♦K♦Q♣10", MasterDecision.BET_2_10);
        test("♠Q♥A", "♣3♦K♦3♣10", MasterDecision.CALL_2);
        test("♠Q♥A", "♣K♦K♦3♣5", MasterDecision.CHECK_OR_FOLD);
        test("♠Q♥A", "♣K♦K♦10♣J", MasterDecision.BET_25_50);
        test("♠Q♥A", "♣5♦4♦J♣9", MasterDecision.CHECK_OR_FOLD);
    ...
    public void suggest49() throws Exception {
        ...
        test("♠4♥9", "♣5♦4♦J♣A", MasterDecision.CHECK_OR_FOLD);
        test("♠4♥9", "♣8♦6♦K♣9", MasterDecision.CALL_2);
    }
